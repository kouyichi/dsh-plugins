...
TUI_BRICKS="dsh-tui-bridge dsh-tui-compact dsh-tui-usage dsh-tui-context dsh-tui-export dsh-tui-theme dsh-tui-todos dsh-tui-history dsh-tui-keymap dsh-tui-commands dsh-tui-btw dsh-tui-update dsh-tui-goals dsh-tui-find"
